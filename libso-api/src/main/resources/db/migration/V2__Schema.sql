...
(
    ...
    CONSTRAINT FOREIGN_KEY_PRODUCT_CATEGORY_PRODUCT FOREIGN KEY (product_id) REFERENCES PRODUCT (id),
    CONSTRAINT FOREIGN_KEY_PRODUCT_CATEGORY_CATEGORY FOREIGN KEY (category_id) REFERENCES CATEGORY (id)
);
...
(
    ...
    CONSTRAINT FOREIGN_KEY_PROMOTION_PRODUCT FOREIGN KEY (product_id) REFERENCES PRODUCT (id)
);
...
(
    ...
    CONSTRAINT FOREIGN_KEY_REVIEW_PRODUCT FOREIGN KEY (product_id) REFERENCES PRODUCT (id)
);
...
(
    ...
    CONSTRAINT FOREIGN_KEY_OFFER_PRODUCT FOREIGN KEY (product_id) REFERENCES PRODUCT (id)
);
...
(
    ...
    CONSTRAINT FOREIGN_KEY_TRANSACTION_USER FOREIGN KEY (user_id) REFERENCES USER (id)
);
...
(
    ...
    CONSTRAINT FOREIGN_KEY_TRANSACTION_PRODUCT_PRODUCT FOREIGN KEY (product_id) REFERENCES PRODUCT (id)
);